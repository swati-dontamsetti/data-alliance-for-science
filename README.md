...
In the end we found "The State of the World’s Children 2019 Statistical Tables" on UNICEF (https://data.unicef.org/resources/dataset/sowc-2019-statistical-tables/).
